...
from .models import Mobile, Laptop, TV, Refrigerator, Content
...
class AllTvSerializer(HyperlinkedModelSerializer):
    """" Serializer for show all Tv with some information"""
    class Meta:
        model = TV
        fields = ('url', 'name', 'img')
...
class AllMobileSerializer(HyperlinkedModelSerializer):
    """" Serializer for show all Mobile with some information"""
    class Meta:
        model = Mobile
        fields = ('url', 'name', 'img')
...
class AllLaptopSerializer(HyperlinkedModelSerializer):
    """" Serializer for show all Laptop with some information"""
    class Meta:
        model = Laptop
        fields = ('url', 'name', 'img')
...
class AllRefrigeratorSerializer(HyperlinkedModelSerializer):
    """" Serializer for show all Refrigerator with some information"""
    class Meta:
        model = Refrigerator
        fields = ('url', 'name', 'img')
